		...
		<div className="d-flex align-items-center mg-b-15">
			{!isLoading ? (
				<span className="bg-gray-100 wd-50 ht-50 rounded-circle d-inline-flex align-items-center justify-content-center">
					<img
						className="wd-30 ht-30 object-fit"
						src={imageUrl || '../assets/img/teacher.jpg'}
					/>
				</span>
			) : (
			...
			<div className="mg-l-10">
				<p className="mg-b-0 tx-medium tx-20 tx-primary">
					{!isLoading ? value : <Skeleton width={25} />}{' '}
				</p>
				<p className="tx-gray-500 mg-b-0">
					{!isLoading ? title : <Skeleton width={25} />}
				</p>
			</div>
		</div>
	);
...
const ModalChangePass = ({
	...
	return (
		<Modal show={showPassword} onHide={hideChangePasswordForm} size="sm">
					...
					<div className="d-flex justify-content-between flex-column h-100">
						...
						<div className="">
							...
							<div className="d-flex flex-column flex-center  tx-center">
								...
								{/*end::Symbol*/}
								{/*begin::Username*/}
								<a href="#" className="card-title tx-primary tx-bolder tx-16">
									{!isLoading ? state.FullName || '' : <Skeleton width={50} />}
								</a>
								{/*end::Username*/}
								{/*begin::Info*/}
								<div className="d-flex justify-content-between align-items-center mg-b-5">
									...
									<span className="tx-gray-400">
										{!isLoading ? state.SkypeID || '' : <Skeleton width={50} />}
									</span>
								</div>
								<div className="d-flex justify-content-between align-items-center mg-b-15">
									...
									>
										{!isLoading ? state.Email || '' : <Skeleton width={50} />}
									</a>
								</div>
							...
							<div className="pt-1">
								...
								<div className="d-flex align-items-center pd-b-15">
									...
									<div className="d-flex flex-column flex-grow-1">
										<span className="tx-dark text-hover-primary mb-1 font-size-lg tx-medium">
											Students
										</span>
									...
									{/*end::Text*/}
									{/*begin::label*/}
									<span className="badge bg-gray-200 pd-y-10 tx-14 wd-35 mg-l-15">
